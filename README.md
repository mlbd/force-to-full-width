...
Download and include in your folder or just copy paste the forceToFullWidth() function from [force2full.js](https://github.com/mlbd/force-to-full-width/blob/master/force2full.js) or use css to do same thing ( but css will work if that inner element has the full width of container.)
